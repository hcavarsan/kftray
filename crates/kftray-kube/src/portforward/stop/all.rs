...
pub async fn stop_all_port_forward_with_mode(
    ...
    for entry in crate::portforward::proxy::recovery::RECOVERY_MANAGERS.iter() {
        entry.value().cancel();
    }
    crate::portforward::proxy::recovery::RECOVERY_MANAGERS.clear();
    crate::portforward::proxy::recovery::RECOVERY_LOCKS.clear();
