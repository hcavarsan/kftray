...
fn handle_tcp_to_udp(
    mut tcp_stream: TcpStream, udp_socket: Arc<UdpSocket>, is_running: Arc<AtomicBool>,
) -> io::Result<()> {
...
fn handle_udp_to_tcp(
    udp_socket: Arc<UdpSocket>, tcp_stream: Arc<Mutex<TcpStream>>, is_running: Arc<AtomicBool>,
) -> io::Result<()> {
