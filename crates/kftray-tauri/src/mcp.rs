...
//!
//! This module handles starting and stopping the MCP server from within the Tauri application.
...
pub async fn init_from_settings() -> Result<(), Box<dyn std::error::Error + Send + Sync>> {
    use kftray_commons::utils::settings::{get_mcp_server_enabled, get_mcp_server_port};
