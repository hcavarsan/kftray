...
- **Multi Protocol:** Kftray allows access to internal or external servers through a Proxy Relay server deployed in a Kubernetes cluster. It provides TCP proxy forwarding and  UDP port forwarding, which are not supported by kubectl.
